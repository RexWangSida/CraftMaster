...
CraftMaster is a 3D sandbox game developed by three software engineering students at Mcmaster University. It is a reimplementation of [@fogleman/Minecraft](https://github.com/fogleman/Minecraft)(refered to as orginal project) which is developed by **_Michael Fogleman_**. CraftMaster is written in [**Python**](https://www.python.org/) with [**Pyglet**](http://pyglet.org/). All the media source are open-source and found online. The executable game is generated by [**Pyintsaller**](https://www.pyinstaller.org/).
We believe the software design principles and software architectural design patterns that we applied to the project significantly increased the quality of the software. The highlights of CraftMaster are the module decomposition and novel functionalities/features of the game.
